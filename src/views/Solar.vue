...
import sun from '../assets/img/sun_bg.jpg';
import '@/assets/img/earth_bg.jpg';
import '@/assets/img/jupiter_bg.jpg';
import '@/assets/img/mars_bg.jpg';
import '@/assets/img/mercury_bg.jpg';
import '@/assets/img/neptune_bg.jpg';
import '@/assets/img/pluto_bg.jpg';
import '@/assets/img/saturn_bg.jpg';
import '@/assets/img/saturn_ring.jpg';
import '@/assets/img/sun_bg.jpg';
import '@/assets/img/uranus_bg.jpg';
import '@/assets/img/venus_bg.jpg';
console.log(sun)
export default {
  name: "Solar",
  mounted() {
...
// scene.add(AxesHelper);
      ...
      planetLabel.position.set(0, 20, 0);
      Sun.add(planetLabel);
...
//添加冥王星
      ...
      function loadPlanet(name, radius, position, speed) {
        ...
        const material = new THREE.MeshBasicMaterial({
          map: loader.load(require(`../assets/img/${name}_bg.jpg`))
        });
        ...
        if (name === 'saturn') {
          const ringMaterial = new THREE.MeshBasicMaterial({
            map: loader.load(require(`../assets/img/${name}_ring.jpg`)),
